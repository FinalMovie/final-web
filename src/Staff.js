...
import {Button, Container, Dropdown, DropdownButton, Modal, Row} from "react-bootstrap";
                                        ...
                                        this.state.foodList.map((value, index) => {
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <th>
                                                        <button onClick={this.addFoodToCart.bind(this, value)}>Add</button>
                                                    </th>
                                                </tr>
                                            )
                                        })
                                        ...
                                        this.state.list.map((value, index) => {
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <th>
                                                        <button onClick={this.handleShowModal.bind(this, value)}>Add</button>
                                                    </th>
                                                    <Modal show={this.state.show} onHide={this.handleClose.bind(this)}>
                                                        ...
                                                        <Modal.Body>
                                                            <DropdownButton id="dropdown-item-button" title="Available Time">
                                                                <Dropdown.Item as="button" eventKey="10:00AM"
                                                                               onSelect={(key) => {
                                                                                   this.handleSelectDate(key)
                                                                               }}>{new Date().getUTCFullYear()}-{new Date().getUTCMonth() + 1}-{new Date().getDate()} 10:00AM</Dropdown.Item>
                                                                <Dropdown.Item as="button" eventKey="11:00AM"
                                                                               onSelect={(key) => {
                                                                                   this.handleSelectDate(key)
                                                                               }}>{new Date().getUTCFullYear()}-{new Date().getUTCMonth() + 1}-{new Date().getDate()} 11:00AM</Dropdown.Item>
                                                                <Dropdown.Item as="button" eventKey="13:00PM"
                                                                               onSelect={(key) => {
                                                                                   this.handleSelectDate(key)
                                                                               }}>{new Date().getUTCFullYear()}-{new Date().getUTCMonth() + 1}-{new Date().getDate()} 13:00PM</Dropdown.Item>
                                                                <Dropdown.Item as="button" eventKey="14:00PM"
                                                                               onSelect={(key) => {
                                                                                   this.handleSelectDate(key)
                                                                               }}>{new Date().getUTCFullYear()}-{new Date().getUTCMonth() + 1}-{new Date().getDate()} 14:00PM</Dropdown.Item>
                                                                <Dropdown.Item as="button" eventKey="15:00PM"
                                                                               onSelect={(key) => {
                                                                                   this.handleSelectDate(key)
                                                                               }}>{new Date().getUTCFullYear()}-{new Date().getUTCMonth() + 1}-{new Date().getDate()} 15:00PM</Dropdown.Item>
                                                                <Dropdown.Item as="button" eventKey="16:00PM"
                                                                               onSelect={(key) => {
                                                                                   this.handleSelectDate(key)
                                                                               }}>{new Date().getUTCFullYear()}-{new Date().getUTCMonth() + 1}-{new Date().getDate()} 16:00PM</Dropdown.Item>
                                                                <Dropdown.Item as="button" eventKey="17:00PM"
                                                                               onSelect={(key) => {
                                                                                   this.handleSelectDate(key)
                                                                               }}>{new Date().getUTCFullYear()}-{new Date().getUTCMonth() + 1}-{new Date().getDate()} 17:00PM</Dropdown.Item>
                                                                <Dropdown.Item as="button" eventKey="18:00PM"
                                                                               onSelect={(key) => {
                                                                                   this.handleSelectDate(key)
                                                                               }}>{new Date().getUTCFullYear()}-{new Date().getUTCMonth() + 1}-{new Date().getDate()} 18:00PM</Dropdown.Item>
                                                            </DropdownButton>
                                                            {
                                                                this.state.isDateSelected ?
                                                                    <Modal.Title>Time
                                                                        Selected: {this.state.selectedTime}</Modal.Title>
                                                                    :
                                                                    ""
                                                            }
                                                        </Modal.Body>
                                                        <Modal.Footer>
                                                            ...
                                                            <Button variant="primary"
                                                                    onClick={this.addToCart.bind(this, value)}>
                                                                Add
                                                            </Button>
                                                        </Modal.Footer>
                                                    </Modal>
